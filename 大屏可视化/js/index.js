...
(function () {
    ...
    var option = {
      ...
      xAxis: [{
        type: 'category',
        data: ["个体", "教培行业", "数据分析师", "医疗行业", "文学工作者", "学生", "金融行业"],
        axisTick: {
          alignWithLabel: true
        },
        // 修改刻度标签，相关样式
  ...
  (function () {
    ...
    var option = {
      ...
      xAxis: [{
        ...
        data: ["18083418329", "15613442539", "13838633280", "18134362246", "13389398064", "18837392427", "18875887650","13397350281", "15640916497", "15002729016"]
      }],
      yAxis: [{
        type: 'value',
        axisTick: {
      ...
      series: [{
          ...
          data:  [28, 89, 59, 34, 85, 26, 79, 23, 22, 35]
        },
        {
          name: "阅读量",
          type: "line",
